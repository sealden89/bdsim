...
*/
#ifndef BDSWRAPPERSCINTILLATIONBIASING_H
#define BDSWRAPPERSCINTILLATIONBIASING_H
...
class BDSWrapperScintillationBiasing: public BDSWrapperProcess
{
public:
  BDSWrapperScintillationBiasing() = delete;
  BDSWrapperScintillationBiasing(G4VProcess* originalProcess,
                          G4int    reductionFactorIn);
  virtual ~BDSWrapperScintillationBiasing();
